...
def donuts(count):
  # +++your code here+++
  if(count <15): number=("Number of donuts: %d" %count)
  elif (15 <=count<=100):  number =("Number of donuts: many")
  elif(count>100): number =("Number of donuts: too much donuts")
  return number 
...
def both_ends(s):
  # +++your code here+++
  if(len(s)< 2): total= ("invalid input")
  else: total = s[0:2]+s[-2:]
    #number1=s[0:2]; 
    #number2=s[-2:];
